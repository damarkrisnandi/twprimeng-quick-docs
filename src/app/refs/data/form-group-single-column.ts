...
import { FormGroupSingleColumnComponent } from "../components/form-group-single-column/form-group-single-column.component";

export const formGroupSingleColumnComponentData: Doc = {
  header: 'Form Group Single Column',
  component: FormGroupSingleColumnComponent,
  files: [
    {
      name: 'form-group-single-column.component.ts',
      type: 'ts',
      content: `
